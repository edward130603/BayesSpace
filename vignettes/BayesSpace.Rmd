...
#>              spot.idx subspot.idx  spot.row  spot.col       row       col  imagerow
#>             <numeric>   <integer> <integer> <integer> <numeric> <numeric> <numeric>
#> subspot_1.1         1           1         7        15   7.33333   15.3333   7.33333
#> subspot_2.1         2           1         7        16   7.33333   16.3333   7.33333
#> subspot_3.1         3           1         7        17   7.33333   17.3333   7.33333
#> subspot_4.1         4           1         7        18   7.33333   18.3333   7.33333
#> subspot_5.1         5           1         8        13   8.33333   13.3333   8.33333
#> subspot_6.1         6           1         8        14   8.33333   14.3333   8.33333
#>              imagecol spatial.cluster
#>             <numeric>       <numeric>
#> subspot_1.1   15.3333               1
#> subspot_2.1   16.3333               1
#> subspot_3.1   17.3333               2
#> subspot_4.1   18.3333               3
#> subspot_5.1   13.3333               1
#> subspot_6.1   14.3333               1
```
