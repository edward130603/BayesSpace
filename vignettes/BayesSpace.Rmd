...
```{r}
sce <- spatialCluster(sce, q=4, init.method="kmeans", model="t", nrep=1000, save.chain=T)
...
```{r}
enhanced <- spatialEnhance(sce, q=4, init.method="kmeans", model="t", nrep=1000, save.chain=T)
