...
<img src="figures/ji_SCC-qTune-1.png" title="plot of chunk qTune" alt="plot of chunk qTune" width="100%" />
...
<img src="figures/ji_SCC-plot.clusters-1.png" title="plot of chunk plot.clusters" alt="plot of chunk plot.clusters" width="100%" />

## Enhancing feature expression

Next we examined the expression of cell-type-specific marker genes reported by
Ji et al. at the spot level and after enhancement. We predicted the marker gene
at enhanced subspot resolution using `xgboost`, tuning the selection of the
`nrounds` parameter with two thirds of the spots. (See documentation of
`enhanceFeatures()` for details.)
...
<img src="figures/ji_SCC-spot.expression-1.png" title="plot of chunk spot.expression" alt="plot of chunk spot.expression" width="100%" />
...
<img src="figures/ji_SCC-enhanced.expression-1.png" title="plot of chunk enhanced.expression" alt="plot of chunk enhanced.expression" width="100%" />
...
<img src="figures/ji_SCC-DE.myeloid-1.png" title="plot of chunk DE.myeloid" alt="plot of chunk DE.myeloid" width="100%" />
...
<img src="figures/ji_SCC-DE.tumor-1.png" title="plot of chunk DE.tumor" alt="plot of chunk DE.tumor" width="100%" />
