...
cluster_mcmc <- function(Y, df_j, nrep, n, d, gamma, q, init, mu0, lambda0, alpha, beta) {
    .Call(`_BayesSpace_cluster_mcmc`, Y, df_j, nrep, n, d, gamma, q, init, mu0, lambda0, alpha, beta)
}
