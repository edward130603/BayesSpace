...
test <- function(d, d0) {
    invisible(.Call(`_BayesSpace_test`, d, d0))
}
...
iterate_deconv <- function(Y, df_j, tdist, nrep, n, n0, d, gamma, q, init, subspots, verbose, jitter_scale, c, mu0, lambda0, alpha, beta, jitter_var, d0) {
    .Call(`_BayesSpace_iterate_deconv`, Y, df_j, tdist, nrep, n, n0, d, gamma, q, init, subspots, verbose, jitter_scale, c, mu0, lambda0, alpha, beta, jitter_var, d0)
}
