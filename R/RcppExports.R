...
iterate_deconv <- function(Y, df_j, nrep, n, n0, d, gamma, q, init, subspots, verbose, c, mu0, lambda0, alpha, beta) {
    .Call(`_BayesSpace_iterate_deconv`, Y, df_j, nrep, n, n0, d, gamma, q, init, subspots, verbose, c, mu0, lambda0, alpha, beta)
}
