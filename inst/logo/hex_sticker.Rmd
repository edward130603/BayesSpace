...
palette <- c("#293241", "#3D5A80", "#98C1D9")
enhanced.color <- "#EE6C4D"
...
s <- hexSticker::sticker(hexplot, package="BayesSpace", 
             ...
             p_y=1,
             p_color="#FFFFFF",
             h_color='#E0FBFC', h_size=2,
             filename="BayesSpace_logo.png") +
  
# overwrite file with better size
ggsave("BayesSpace_logo.png", width=(6/1.1547005), height=6, bg="transparent")
s
```