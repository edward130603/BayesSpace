...
arma::mat updateMu(arma::mat Y, int q, arma::rowvec z_prev, arma::vec w, arma::mat lambda0, arma::mat lambda_prev, arma::colvec mu0vec) {
...
arma::mat updateLambda(arma::mat Y, arma::mat mu_i_long, arma::rowvec z_prev, arma::vec w, double alpha, double beta) {
...
List cluster_mcmc (arma::mat Y, List df_j, int nrep, double gamma, int q, 
  ...
  for (int i = 1; i < nrep; i++){
    ...
    //Update mu
    mat mu_i = updateMu(Y, q, z_prev, w, lambda0, lambda_prev, mu0vec);
    ...
    //Update lambda
    mat lambda_i = updateLambda(Y, mu_i_long, z_prev, w, alpha, beta);
